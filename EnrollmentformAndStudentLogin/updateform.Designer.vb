...
Partial Class updateform
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(updateform))
        ...
        lblFather.Location = New Point(871, 2)
        ...
        Panel13.Controls.Add(btnUpdateForm)
        ...
        Label22.Location = New Point(25, 194)
        ...
        lblInformation.Location = New Point(3, 169)
        ...
        btnUpdateForm.FlatAppearance.BorderColor = Color.FromArgb(CByte(64), CByte(64), CByte(64))
        btnUpdateForm.FlatStyle = FlatStyle.System
        btnUpdateForm.Font = New Font("Segoe UI Semibold", 9.75F, FontStyle.Bold, GraphicsUnit.Point)
        btnUpdateForm.Location = New Point(61, 243)
        btnUpdateForm.Name = "btnUpdateForm"
        btnUpdateForm.Size = New Size(113, 41)
        btnUpdateForm.TabIndex = 0
        btnUpdateForm.Text = "Update form"
        ...
        btnReset.Location = New Point(61, 290)
    ...
    Friend WithEvents btnUpdateForm As Button
