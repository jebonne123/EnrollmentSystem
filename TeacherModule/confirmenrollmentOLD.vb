...
Public Class confirmenrollmentOLD
    ...
    Private Sub btn_Click(sender As Object, e As EventArgs) Handles btn.Click
        ...
        Try
            MysqlConn.Open()
            Query2 = "INSERT INTO enrollmentdb.enrollment(STUDENT_CODE, TEACHER_ID, HOMEROOM_ID, AY_CODE, ENROLL_DATE) values ('" & txtOldStudentSCode.Text & "', '" & txtshowtID.Text & "', '" & txtHomeroomIDShow.Text & "', '" & txtshowAycode.Text & "', '" & txtShowDate.Text & "')"
